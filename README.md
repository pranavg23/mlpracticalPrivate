 ...
 * Detailed instructions are given in CW 1 Instructions (see Learn, Assessment).
 * The [report directory](https://github.com/VICO-UoE/mlpractical/tree/mlp2023-24/coursework1/report) contains the latex files that you will use to create your report.
